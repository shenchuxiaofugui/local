...
df_path=['']*number
select_df=['']*number
feature_path[0]=r'\\mega\syli\dataset\EC_all\yuchuli\T2\original\firstorder\result\MinMax\PCC\RFE_1\RFE_train_feature.csv'
df_path[0]=r'\\mega\syli\dataset\EC_all\yuchuli\T2\T2.csv'
feature_path[1]=r'\\mega\syli\dataset\EC_all\yuchuli\T2\original\shape\result\MinMax\PCC\Relief_6\Relief_train_feature.csv'
df_path[1]=r'\\mega\syli\dataset\EC_all\yuchuli\T2\T2.csv'
feature_path[2]=r'\\mega\syli\dataset\EC_all\yuchuli\T2\original\texture\result\MinMax\PCC\KW_4\KW_train_feature.csv'
df_path[2]=r'\\mega\syli\dataset\EC_all\yuchuli\T2\T2.csv'
...
zong_df.to_csv(r'\\mega\syli\dataset\EC_all\yuchuli\T2\zong\zong.csv',index=False)