...
df = pd.read_csv(r'\\mega\syli\dataset\Primary and metastatic\zong.csv')
...
df1=df[['Ascites','DWI.nii_original_glcm_Idmn','DWI.nii_original_glrlm_LowGrayLevelRunEmphasis',\
        'DWI.nii_original_glrlm_RunLengthNonUniformityNormalized','T1CE.nii_wavelet-HHL_glcm_Imc1']]
#df1=df.iloc[:,2:]
...
plt.savefig(r'\\mega\syli\dataset\Primary and metastatic\sns_heatmap_center1.jpg', dpi=300)
#plt.show()
